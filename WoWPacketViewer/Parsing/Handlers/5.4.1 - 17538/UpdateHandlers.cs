...
namespace WoWPacketViewer.Parsing.Handlers.V541_17538
{
    ...
    public static class UpdateHandlers
    {
        ...
        public static void HandleUpdateObject(Packet packet)
        {
            ...
            {
                var type = packet.ReadEnum<UpdateType, Byte>(EnumType.FullName, "{0}: Update type", blockId);
        ...
        private static void HandleCreateUpdateBlock(uint blockId, Packet packet, UpdateType updateType)
        {
            ...
            var objectTypeId = packet.ReadEnum<ObjectType, Byte>(EnumType.FullName, "{0}: Object type", blockId);
